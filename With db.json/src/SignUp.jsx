            ...
            <div className='bg-white p-3 rounded w-25'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='mb-3'>
                        ...
                        <input type="text" id="username" name="username" placeholder='Enter User Name' className='form-control rounded-0' onChange={handleInput} />
                        {errors.username && <div className="text-danger">{errors.username}</div>}
                    </div>
                    <div className='mb-3'>
                        <label htmlFor="role"><strong>Role</strong></label>
                        <select id="role" name="role" className='form-control rounded-0' onChange={handleInput}>
                    ...
                    <div className='mb-3'>
                        ...
                        <input type="text" id='phone' name='phone' placeholder='Enter Phone' className='form-control rounded-0' onChange={handleInput} maxLength={10} />
                    ...
                    <div className='mb-3'>
                        ...
                        <input type="password" id="confirmPassword" name="confirmPassword" placeholder='Re-enter Password' className='form-control rounded-0' onChange={handleInput} />
