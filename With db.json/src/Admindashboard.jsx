...
const AdminDashboard = () => {
    ...
    const fetchCompanies = async () => {
        try {
            const response = await axios.get('http://localhost:3000/companies'); // Use the correct endpoint
    ...
    const handleDelete = async (companyId) => {
        try {
            await axios.delete(`http://localhost:3000/companies/${companyId}`); // Use the correct endpoint
    ...
    const handleApprove = async (companyId) => {
        try {
            await axios.patch(`http://localhost:3000/companies/${companyId}/approve`); // Use the correct endpoint
